...
export const AgentSchema = z.object({
  ...
  voiceMode: z.enum(['legacy', 'realtime']).optional(),
  launchStatus: z.enum(['draft', 'testing', 'ready_to_launch', 'paid', 'live']).optional(),
  phoneMode: z.enum(['none', 'dedicated_number', 'existing_number_forwarding']).optional(),
